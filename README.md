...
| has_discussions                   | (see description)             | Dynamic default. _true_ if `visibility` is `public`, _false_ otherwise                                                                                                                                                                                       |
| has_issues                        | (see description)             | Dynamic default. _true_ if `visibility` is `public`, _false_ otherwise                                                                                                                                                                                       |
| has_projects                      |                               | Set to true to enable the GitHub Projects features on the repository                                                                                                                                                                                         |
| has_wiki                          | false                         | Set to true to enable the GitHub Wiki features on the repository                                                                                                                                                                                             |
...
| template_include_all_branches     | _false_                       | Whether the new repository should include all the branches from the template repository (defaults to false, which includes only the default branch from the template)                                                                                        |
